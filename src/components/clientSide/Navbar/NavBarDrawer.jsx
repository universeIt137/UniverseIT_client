        ...
        <>
            ...
            <Drawer open={open} onClose={closeDrawer} className="bg-white">
                <div className="bg-primary/20 h-full">
                    ...
                    <div className="px-4">
                        <div className='relative block xl:hidden '>
                            <input className=' pl-10 px-5 py-3 border-[2.5px] border-gray-200 w-full xl:w-[400px] rounded-lg outline-none' type="text" placeholder='What do you want to learn?' />
                            <FiSearch className='absolute top-4 left-3 text-gray-500 text-lg' />
                        </div>
                    </div>
                </div>
